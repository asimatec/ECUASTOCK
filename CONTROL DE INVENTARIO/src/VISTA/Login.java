...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtUsuario.setBackground(new java.awt.Color(53, 152, 219));
        txtUsuario.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
        jPanel1.add(txtUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 180, 240, -1));
        ...
        clave.setBackground(new java.awt.Color(53, 152, 219));
        clave.setBorder(null);
        jPanel1.add(clave, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 250, 240, -1));
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
         ...
         Login_DAO con = new Login_DAO();

        if (con.obtenerAcceso(txtUsuario.getText(),String.valueOf(clave.getPassword()))  == 1) {
            dispose();
